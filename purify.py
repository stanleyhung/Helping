...
with open('/home/vagrant/kelly/Kelly_Interviews.csv', 'Ub') as csvfile:
	with open('/home/vagrant/kelly/Kelly_Offers2.csv', 'Ub') as csvfile2:
		...
		db.execute("COPY INTERVIEWS FROM '/home/vagrant/kelly/Kelly_Interviews.csv' DELIMITER ',' CSV;")
		...
		db.execute("COPY OFFERS FROM '/home/vagrant/kelly/Kelly_Offers2.csv' DELIMITER ',' CSV;")
